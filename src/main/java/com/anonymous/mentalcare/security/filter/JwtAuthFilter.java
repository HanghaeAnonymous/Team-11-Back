package com.anonymous.mentalcare.security.filter;

import com.anonymous.mentalcare.security.jwt.HeaderTokenExtractor;
import com.anonymous.mentalcare.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        System.out.println("request Authorization header : " + tokenPayload + " / " + (tokenPayload == null));
